...
//移动端 头部组件
 ...
 class MobileNewsHeader extends Component {
    ...
    handleSubmit = (isRegist,event) => {
        ...
        //收集输入数据，准备url
        const {username, password, r_userName, r_password, r_confirmPassword} =
        ...
        render() {
            ...
            ? <Link to="/user_center">
                ...
                : <Icon type="setting" onClick={this.change}/>
return (
<div id="mobileheader">
    <header>
        <div id="mobileheader">
    ...
    <Modal title="用户中心"
        ...
        okText="关闭">
        <Tabs type="card" onChange={()=>this.props.form.resetFields}></Tabs>
